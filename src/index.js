                ...
                switch (_a.label) {
                    ...
                    case 8:
                        if (action === 'exit') {
                            ...
                            neverValue = action;
                            throw new Error(neverValue + " is an invalid acition");
                        }
                        _a.label = 9;
...
var HitAndBlow = /** @class */ (function () {
    function HitAndBlow() {
        // private修飾子を用いると、classの中からしか参照できなくなる
    ...
    HitAndBlow.prototype.validate = function (inputArr) {
        ...
        var isAllDefferentValues = inputArr.every(function (val, i) { return inputArr.indexOf(val) === i; });
        return isLengthValid && isAllAnswerSourceOption && isAllDefferentValues;
    };
    ;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        answerLength = this.getAnswerLength();
                        return [4 /*yield*/, promptInput("\u300C,\u300D\u533A\u5207\u308A\u3067" + answerLength + "\u500B\u306E\u6570\u5B57\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044")];
                    case 1:
...
var Janken = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!(Number.isInteger(rounds) && rounds > 0)) return [3 /*break*/, 2];
                        this.rounds = rounds;
                        return [3 /*break*/, 4];
    ...
    Janken.prototype.play = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, promptSelect("\uFF3B " + this.rounds + " \u56DE\u6226\b\uFF3D\u9078\u629E\u80A2\u3092\u5165\u529B\u3057\u3066\u304F\u3060\u3055\u3044", jankenOptions)];
                    case 1:
                        userSelected = _a.sent();
                        randomSelected = jankenOptions[Math.floor(Math.random() * jankenOptions.length)];
    ...
    Janken.prototype.end = function () {
        printLine(this.result.win + "\u52DD" + this.result.lose + "\u6557" + this.result.draw + "\u5F15\u304D\u5206\u3051\u3067\u3057\u305F\u3002");
        this.reset();
    };
    ;
